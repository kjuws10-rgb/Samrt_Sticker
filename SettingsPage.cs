...
public sealed class SettingsPage : Grid
{
    public SettingsPage(SettingsStore store, Action goBack)
    {
        ...
        panel.Children.Add(new TextBlock { Text = "모든 메모 펼치기 단축키", Margin = new Thickness(0, 14, 0, 3) }); var showAllHotkey = new TextBox { Text = s.ShowAllNotesShortcut, Padding = new Thickness(8, 5, 8, 5), ToolTip = "예: Ctrl + Shift + F6" }; panel.Children.Add(showAllHotkey);
