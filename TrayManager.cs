...
public sealed class TrayManager : IDisposable
{
    ...
    public TrayManager(Action showDashboard, Action newNote, Action capture, Action exit)
    {
        ...
        _icon = new Forms.NotifyIcon { Icon = SystemIcons.Application, Text = "Smart Sticker", Visible = true, ContextMenuStrip = menu };
